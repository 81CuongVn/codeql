...
//   // TODO find a more unique string working also when different modules are compiled with the
//   same
//   // name
...
//   }
//   // there can be separate declarations (`VarDecl` or `AccessorDecl`) which are effectively the
//   same
//   // (with equal mangled name) but come from different clang modules. This is the case for
//   example
